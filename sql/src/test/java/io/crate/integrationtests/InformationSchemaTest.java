...
public class InformationSchemaTest extends SQLTransportIntegrationTest {
    ...
    public void testSelectStarFromInformationSchemaTableWithOrderBy() throws Exception {
        ...
        assertThat(response.rows()[0][7], is(DocIndexMetaData.DEFAULT_ROUTING_HASH_FUNCTION_PRETTY_NAME));
        ...
        assertThat(response.rows()[1][7], is(DocIndexMetaData.DEFAULT_ROUTING_HASH_FUNCTION_PRETTY_NAME));
    ...
    public void testSelectStarFromInformationSchemaTableWithOrderByAndLimitOffset() throws Exception {
        ...
        assertThat(response.rows()[0][7], is(DocIndexMetaData.DEFAULT_ROUTING_HASH_FUNCTION_PRETTY_NAME)); // routing_hash_function
